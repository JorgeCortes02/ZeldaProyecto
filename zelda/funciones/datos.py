...
dades = { "death" : {"arboles" : [(7,19), (8,18), (9,18)]}
}n
...
objetos_hyrule = {" ":{"funciones":f.cesped},
                  ...
                  "M":{"posicion":[[9,46]],"abierto":[False,False],"cierre":f.cerrar_cofre_sword,"funcion":f.cofre}, #-Falta la funcion de cerrar los cofres
                  "E":{"posicion":[[[9,21],[9,22]],[[5,36],[5,35]]],"vidas":5,"funcion":f.enemigo}}
